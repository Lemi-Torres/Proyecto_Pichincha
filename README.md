...
El objetivo del banco era generar la mejor experiencia de usuario en el contexto de COVID-19 y entre sus diversos productos financieros decidimos enfocarnos en captar cuentas de ahorros, ya que actualmente esto se había convertido en una necesidad para las personas y en una oportunidad para los bancos.
Nuestro foco principal fue buscar una solución digital que ayudase a las y los usuarios a poder aperturar su cuenta de ahorros sin que se encuentren en las oficinas del banco. 
...
Detalles: Los usuarios serán atendidos por Nora, la asesora virtual del banco Pichincha. El chatbot adicional a enviar mensajes de texto también puede enviar videos, esto ayuda a que la información brindada sea más dinámica y entendible para los usuarios.
